...
public class DriveConstants {
  ...
  public static final RobotConfig PP_CONFIG = new RobotConfig(
      ...
      new ModuleConfig(
          ...
          1),
      moduleTranslations);
  public static final double achievedMaxSpeed = 5.84;
  public static final double maxAccel = 7.8867;
  public static final double maxAngularVelo = TunerConstants.kSpeedAt12Volts.in(MetersPerSecond)
  ...
  public static final DriveTrainSimulationConfig mapleSimConfig =
      DriveTrainSimulationConfig.Default()
          ...
          .withTrackLengthTrackWidth(trackWidth, wheelBase)
