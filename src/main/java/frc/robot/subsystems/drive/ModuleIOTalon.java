...
public class ModuleIOTalon implements ModuleIO {
  ...
  // protected final PositionTorqueCurrentFOC positionTorqueCurrentRequest = new
  ...
  public ModuleIOTalon(
    ...
    turnPositionQueue =
        PhoenixOdometryThread.getInstance().registerSignal(turnAbsolutePosition.clone());
  ...
  public void setDriveVelocity(double veloctiyRadPerSec) {
    double motorVeloctyRotationsPerSec =
        Units.radiansToRotations(veloctiyRadPerSec) * constants.DriveMotorGearRatio;
