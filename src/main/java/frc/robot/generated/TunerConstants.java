...
public class TunerConstants {
  ...
  /// WEBSITE FOR CALCULATING SWERVE
  ...
  // This needs to be tuned to your individual robot
  public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(6.03);
  ...
  private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.276855);
  private static final boolean kFrontLeftSteerMotorInverted = true;
  private static final boolean kFrontLeftEncoderInverted = false;

  private static final Distance kFrontLeftXPos =
      Meters.of(DriveConstants.trackWidth.div(2).in(Meters));
  private static final Distance kFrontLeftYPos =
      Meters.of(DriveConstants.wheelBase.div(2).in(Meters));

  // Front Right
  private static final int kFrontRightDriveMotorId = 3;
  private static final int kFrontRightSteerMotorId = 4;
  private static final int kFrontRightEncoderId = 11;
  private static final Angle kFrontRightEncoderOffset = Rotations.of(-0.438477);
  ...
  private static final Distance kFrontRightYPos =
      Meters.of(DriveConstants.wheelBase.div(2).unaryMinus().in(Meters));

  // Back Left
  private static final int kBackLeftDriveMotorId = 7;
  private static final int kBackLeftSteerMotorId = 8;
  private static final int kBackLeftEncoderId = 10;
  private static final Angle kBackLeftEncoderOffset = Rotations.of(0.168945);
  private static final boolean kBackLeftSteerMotorInverted = true;
  private static final boolean kBackLeftEncoderInverted = false;

  private static final Distance kBackLeftXPos =
      Meters.of(DriveConstants.trackWidth.div(2).unaryMinus().in(Meters));
  ...
  private static final Angle kBackRightEncoderOffset = Rotations.of(-0.357422);
