...
//   private static final AngularAcceleration WHEEL_RADIUS_RAMP_RATE =
...
//           Logger.recordOutput("Rotation/ChassisOmega", omega *
...
//         drive);
//   }
//   /** This command is useful for snapping onto an angle while driving, using a PID Controller to
// keep specified angle while driving (not really like a turret) */
//   public static Command joystickDriveAtAngle(
//       DriveSubsystem drive,
//       DoubleSupplier xSupplier,
//       DoubleSupplier ySupplier,
//       Supplier<Rotation2d> rotationSupplier) {
//     Logger.recordOutput("Rotation we snapped on to", rotationSupplier.get());
...
//   /** This command snaps onto a given static pose (like a pose from pathplanner easy way to make
// pose), useful for 2026 because we really only need to snap onto the hub ever... (turret for real)
// */
...
//               // double omega = angleController.calculate(
//               //     isFlipped ? -thetaSupplier.getAsDouble() : thetaSupplier.getAsDouble(), 0);
//               double omega = -angleController.calculate(
...
//                 () -> {
//                   double speed =
// limiter.calculate(WHEEL_RADIUS_MAX_VELOCITY.in(RadiansPerSecond));
...
//             Commands.runOnce(() -> {
//               state.positions =
//                   Arrays.stream(drive.getWheelRadiusCharacterizationPositions()).toArray();
...
//                 // When cancelled, calculate and print results
//                 .finallyDo(() -> {
//                   double[] positions = Arrays.stream(
...
//                   }
//                   double wheelRadius =
//                       (state.gyroDelta * DriveConstants.DRIVE_BASE_RADIUS.in(Meters)) /
// wheelDelta;
