...
public class DriveCommands {
  ...
  /** This command is useful for snapping onto an angle while driving, using a PID Controller to keep specified angle while driving (not really like a turret) */
  ...
  public static Command turretDrive(
    ...
    return Commands.run(
            () -> {
              ...
              double omega = angleController.calculate(-thetaSupplier.getAsDouble(), 0);
